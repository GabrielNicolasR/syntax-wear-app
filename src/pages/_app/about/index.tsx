...
function RouteComponent() {
  return <section className='flex flex-col md:flex-row items-center md:h-screen'>
    <div className='h-100 md:h-full md:w-1/2'>
      <img src={bannerAbout} alt="Homem sentado com marca de tênis" className='size-full object-cover' />
    </div>
    <div className='px-8 py-16 lg:px-20 md:w-1/2 h-full flex flex-col justify-center'>
      ...
      <Link to="/our-stores" className='self-start text-xs font-bold text-[#333333] uppercase border-b-2 tracking-[2.5px] hover:text-accent transition-colors duration-400'>Saiba mais sobre nossas lojas</Link>
    </div>
  </section>
}
