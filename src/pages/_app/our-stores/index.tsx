...
function RouteComponent() {
    return <section className='container py-6'>
        <img
            src={OurStoresBanner} alt="Banner do interior da loja, com os tênis expostos"
            className='rounded-[20px] h-80 md:h-125 object-cover w-full'
        />
        <div>
            <h1 className='text-2xl max-w-7xl m-auto my-20 text-center'>Nossas lojas são o coração da nossa marca. Explore a coleção mais recente, experimente seus modelos favoritos e sinta o conforto da Syntaxwear pessoalmente.</h1>
            ...
            <section className='w-full space-y-20'>
                <div className='flex flex-col md:flex-row items-center gap-2.5'>
                    ...
                    <img src={OurStoresImg1} alt="Imagem de um tênis da loja" className='rounded-[20px] order-1 md:order-2 md:max-w-[42vw] aspect-10/7 object-cover size-full' />
                </div>
